...
<!-- Sidebar end=============================================== -->
		...
		<p class="text-danger"><h1>${mess}</h1>
		</c:if>
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center"><a class="btn" href="detail?id=${o.id}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="detail?id=${o.id}">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">${o.price}</a></h4>
					</div>
				  </div>
				</li>
				</c:forEach>
