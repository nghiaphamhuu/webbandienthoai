...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="home">Products</a> <span class="divider">/</span></li>
    <li class="active">product Details</li>
    </ul>	
	<div class="row">	  
			<div id="gallery" class="span3">
            <a href="${detailP.img}" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="${detailP.img}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				...
				<hr class="soft"/>
				<form action="cart" method="get" class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>$${detailP.price}</span></label>
					<div class="controls">
					<input name="id"  value="${detailP.id }" style="display:none"/>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">${detailP.brand }</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2">${detailP.type}</td></tr>
